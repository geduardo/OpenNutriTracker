...
1. Append a summary of changes to the task (use `edit --append`)
2. Run `finish <TASK-ID>` (changes orange → cyan)
3. Inform the human what was done
4. The human reviews and marks cyan → green (or back to red for rework)
